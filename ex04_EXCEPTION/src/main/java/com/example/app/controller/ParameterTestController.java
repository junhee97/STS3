...
public class ParameterTestController {
	...
	public void p08(@PathVariable("username") String username, @PathVariable int age, @PathVariable String addr) {
	...
	public void page01(PersonDto dto, Model model) {
		...
		// 반환자료형이 void 일때 /WEB-INF/views/param/page01.jsp 와 매핑
	...
	public String page02(PersonDto dto, Model model) {
		...
		// 반환자료형이 void 일때 /WEB-INF/views/param/page02.jsp 와 매핑
		...
		// 반환 자료형 void : /WEB-INF/views/param/page02.jsp 와 매핑
	...
	public String r1(Model model, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addAttribute("r1", "r1Value"); // QueryString
	...
	public String r2(Model model, @RequestParam("r1") String r1, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addAttribute("r1", r1); // QueryString
		redirectAttributes.addAttribute("r2", "r2Value"); // QueryString
